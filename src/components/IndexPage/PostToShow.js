...
function PostsToShow ({firstChunk,lastChunk, pageContext}) { //  console.log(firstChunk) ; console.log(lastChunk) 
        ...
        <>
            <div className="index">
                <ProjectThumb classMod="index">
                    { firstChunk.map( e => {
                        return <Row element={e} key={e.date} pageContext={pageContext} /> 
                    })}
                </ProjectThumb>
                <ShowMore />
